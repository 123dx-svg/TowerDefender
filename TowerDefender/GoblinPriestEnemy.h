#ifndef __GOBLIN_PRIEST_ENEMY_H_
#define __GOBLIN_PRIEST_ENEMY_H_
#include "Enemy.h"
...
public:
	GoblinPriestEnemy()
	{
		...
		anim_up.SetFrameData(tex_goblin_priest, 5, 4, idx_list_up);
		anim_down.SetLoop(true); anim_down.SetInterval(0.15);
		anim_down.SetFrameData(tex_goblin_priest, 5, 4, idx_list_down);
		anim_left.SetLoop(true); anim_left.SetInterval(0.15);
		anim_left.SetFrameData(tex_goblin_priest, 5, 4, idx_list_left);
		anim_right.SetLoop(true); anim_right.SetInterval(0.15);
		anim_right.SetFrameData(tex_goblin_priest, 5, 4, idx_list_right);

		anim_up_sketch.SetLoop(true); anim_up_sketch.SetInterval(0.15);
		anim_up_sketch.SetFrameData(tex_goblin_priest_sketch, 5, 4, idx_list_up);
		anim_down_sketch.SetLoop(true); anim_down_sketch.SetInterval(0.15);
		anim_down_sketch.SetFrameData(tex_goblin_priest_sketch, 5, 4, idx_list_down);
		anim_left_sketch.SetLoop(true); anim_left_sketch.SetInterval(0.15);
		anim_left_sketch.SetFrameData(tex_goblin_priest_sketch, 5, 4, idx_list_left);
		anim_right_sketch.SetLoop(true); anim_right_sketch.SetInterval(0.15);
		anim_right_sketch.SetFrameData(tex_goblin_priest_sketch, 5, 4, idx_list_right);
		...
		timer_skill.SetWaitTime(recover_interval);
	}
...
#endif // __GOBLIN_PRIEST_ENEMY_H_