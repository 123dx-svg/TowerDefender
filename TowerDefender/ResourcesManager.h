...
//获取资源
	const FontPool& GetFontPool() const { return font_pool; }
	const TexturePool& GetTexturePool() const { return texture_pool; }
	const SoundPool& GetSoundPool() const { return sound_pool; }
	const MusicPool& GetMusicPool() const { return music_pool; }
